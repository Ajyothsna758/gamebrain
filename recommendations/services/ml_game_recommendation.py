from services.ml_new_user_rec import ml_new_user_recommendations
...
def get_recommendations(user, limit=100):
    ...
    if has_history:
        return ml_existing_user_recommendations(user, limit=100)
    else:
        return ml_new_user_recommendations(user, limit=100)
