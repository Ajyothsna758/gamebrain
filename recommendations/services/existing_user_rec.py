...
def get_candidate_games(games_metadata, limit=1000):
    """
    ...
    return (Game.objects.filter(q)
            ...
            .prefetch_related("genres", "platforms", "game_modes", "player_perspectives","themes", "franchises")
...
def existing_user_recommendations(user, limit=10):
    ...
    candidates = get_candidate_games(user_meta, limit=500)

    heap = []

    for game in candidates:
        score, reasons = score_game(game, user_meta)
